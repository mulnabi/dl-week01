...
# .replace(np.nan, 'b') : 결측치를 문자열로 바꾸기 함수를 통해 처리
...
# 오징어 게임을 검색한 조건을 넷플릭스 데이터에 널어서 True인 값만 출력
netflix[netflix['title'].str.contains('S')]